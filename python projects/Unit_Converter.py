...
button_convert = ttk.Button(root, text="Convert", command=convert, style="TButton")
button_convert.pack(pady=10)

label_result = ttk.Label(root, text="", font=("Arial", 14), background="#f0f4f7", foreground="#333")
